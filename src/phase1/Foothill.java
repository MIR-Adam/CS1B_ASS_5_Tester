   ...
   static void loadCardIcons()
   {
      ...
      for (intSuit = 0; intSuit < 4; intSuit++)
         for (intVal = 0; intVal < 14; intVal++ )
         {
            ...
            icon[intSuit*14 + intVal] = imageIcon;
         }
      imageFileName = "images/BK.gif";
      ImageIcon tempImageIcon = new ImageIcon(imageFileName);
      tempImageIcon.setDescription("icon"+(icon.length - 1));
      icon[icon.length - 1]=tempImageIcon;
   }
