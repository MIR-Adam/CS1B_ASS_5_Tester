...
public class GUICard {
	...
	public static void loadCardIcons() {
		...
		for (suit = 0; suit < MAX_SUITS; suit++) {
			...
			iconCards[MAX_VALUE - 1][MAX_SUITS - 1] = new ImageIcon(cardImageLocationString);
		}
		// set iconBack for iconCards index
		iconBack = iconCards[MAX_VALUE - 1][MAX_SUITS - 1];
	...
	public static Card.Suit turnIntIntoCardSuit(int cs) {
		if (cs < 0 || cs > 3) {
